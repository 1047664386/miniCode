...
import type { ProviderProfile } from '../store/index.js';
import { getOrCreateRotator, AllKeysCooldownError } from './key-rotator.js';

/** LLM 调用错误分类，与 KeyRotator.markFailure 共享 */
export type LLMErrorKind = 'network' | 'http_429' | 'http_5xx' | 'http_401' | 'timeout' | 'unknown';
